...
<Callout>
  ...
  [adapter](/docs/@mizuwallet-sdk/aptos-wallet-adapter). If you have an
  [appID](/docs/guide/appid) and advanced development ability, please continue
  reading.
</Callout>
...
Initialized by [**APP_ID**](/docs/guide/appid)
