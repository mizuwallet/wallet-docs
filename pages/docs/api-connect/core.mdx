...
<Callout>
  NOTICE: If you want to quickly start developing an app, directly use the
  features of the Mizu ecosystem. It is recommended to prioritize using the
  [adapter](/docs/using-aptos-wallet-adapter/aptos-wallet-adapter). If you have
  an [appID](/docs/preparation/mizu-app-id) and advanced development ability,
...
Initialized by [**APP_ID**](/docs/preparation/mizu-app-id)
