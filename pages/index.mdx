---
title: MizuWallet – The Seamless Next-Gen Wallet On Aptos
---

import Link from "next/link";
import styles from "./index.module.css";

<div className="home-content min-h-fill-body">
  <div className="content-container">
    <h1 className="headline">Mizu Wallet</h1>
    <p className="subtitle">The Seamless Next-Gen Wallet on Aptos</p>
